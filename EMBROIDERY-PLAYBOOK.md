...
- [`tatreez/tatreez-embroidery-knowledge.md`](tatreez/tatreez-embroidery-knowledge.md) — Palestinian tatreez counted cross-stitch garment panels (fixed grid of X's; its own step-5 primitive)
